...
from apps.ads.schemas.reference_schemas import (  # Car Generations schemas; Car Modifications schemas
    ...
    car_modifications_create_schema,
    car_modifications_delete_schema,
    car_modifications_list_schema,
    car_modifications_retrieve_schema,
    car_modifications_update_schema,
)
from apps.ads.serializers.reference_serializers import (
    CarColorChoiceSerializer,
    CarColorDetailSerializer,
    CarColorListSerializer,
    CarGenerationDetailSerializer,
    CarGenerationListSerializer,
    CarGenerationWithModificationsSerializer,
    CarMarkChoiceSerializer,
    CarMarkDetailSerializer,
    CarMarkListSerializer,
    CarMarkWithModelsSerializer,
    CarModelChoiceSerializer,
    CarModelDetailSerializer,
    CarModelListSerializer,
    CarModelWithGenerationsSerializer,
    CarModificationDetailSerializer,
    CarModificationListSerializer,
)
from core.pagination import ReferenceDataPagination, StandardResultsSetPagination
...
# Car Marks Views
class CarMarkListCreateView(BaseReferenceListCreateView):
    """
    List all car marks or create a new car mark.
    """

    queryset = (
        CarMarkModel.objects.all()
        .order_by("name")
        .annotate(models_count=Count("models"))
    )
    filterset_fields: list = ["is_popular"]
    search_fields: list = ["name"]
    ordering_fields: list = ["name", "created_at", "is_popular"]
    ordering: list = ["name"]
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(
                description="List of car marks", schema=CarMarkListSerializer(many=True)
            )
        },
    )
...
class CarMarkRetrieveUpdateDestroyView(BaseReferenceRetrieveUpdateDestroyView):
    """
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(
                description="Car mark details", schema=CarMarkDetailSerializer
            ),
...
def car_marks_popular(request):
    ...
    queryset = (
        CarMarkModel.objects.filter(is_popular=True)
        .order_by("name")
        .annotate(models_count=Count("models"))
    )
...
def car_marks_choices(request):
    ...
    queryset = (
        CarMarkModel.objects.all().select_related("vehicle_type").order_by("name")
    )
...
def car_marks_with_models(request, pk):
    ...
    try:
        ...
        return Response(
            {"error": "Car mark not found"}, status=status.HTTP_404_NOT_FOUND
        )
...
# Car Models Views
class CarModelListCreateView(BaseReferenceListCreateView):
    """
    ...
    queryset = (
        ...
        .select_related("mark")
        .order_by("mark__name", "name")
        .annotate(generations_count=Count("generations"))
    )
    filterset_fields: list = ["mark", "is_popular"]
    search_fields: list = ["name", "mark__name"]
    ordering_fields: list = ["name", "mark__name", "created_at", "is_popular"]
    ordering: list = ["mark__name", "name"]
...
class CarModelRetrieveUpdateDestroyView(BaseReferenceRetrieveUpdateDestroyView):
    """
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(
                description="Car model details", schema=CarModelDetailSerializer
            ),
...
@swagger_auto_schema(
    ...
    tags=["🚗 Car Models"],
    responses={200: "Success response with models data", 404: "Car mark not found"},
)
@api_view(["GET"])
@permission_classes([])  # Public access
def car_models_by_mark(request):
    ...
    queryset = (
        CarModel.objects.filter(mark_id=mark_id)
        .select_related("mark")
        .order_by("name")
        .annotate(generations_count=Count("generations"))
    )
...
@swagger_auto_schema(
    ...
    tags=["🚗 Car Models"],
    responses={200: "Success response with popular models data", 404: "Not found"},
)
@api_view(["GET"])
@permission_classes([])  # Public access
def car_models_popular(request):
    ...
    queryset = (
        CarModel.objects.filter(is_popular=True)
        .select_related("mark")
        .order_by("mark__name", "name")
        .annotate(generations_count=Count("generations"))
    )
...
@swagger_auto_schema(
    ...
    tags=["🚗 Car Models"],
    responses={200: "Success response with models choices data", 404: "Not found"},
)
@api_view(["GET"])
@permission_classes([])  # Public access
def car_models_choices(request):
    ...
    queryset = (
        CarModel.objects.all().select_related("mark").order_by("mark__name", "name")
    )
...
@swagger_auto_schema(
    ...
    manual_parameters=[
        openapi.Parameter(
            "count",
            openapi.IN_QUERY,
            description="Number of random models to return (default: 10, max: 100)",
...
def car_models_random(request):
    ...
    models = CarModel.objects.select_related("mark", "mark__vehicle_type").order_by(
        "?"
    )[:count]
...
@swagger_auto_schema(
    ...
    manual_parameters=[
        openapi.Parameter(
            "count",
            openapi.IN_QUERY,
            description="Number of random locations to return (default: 1, max: 50)",
            type=openapi.TYPE_INTEGER,
        ),
    ],
    responses={
...
def car_models_with_generations(request, pk):
    ...
    try:
        model = (
            CarModel.objects.select_related("mark")
            .prefetch_related("generations")
            .get(pk=pk)
        )
    except CarModel.DoesNotExist:
        return Response(
            {"error": "Car model not found"}, status=status.HTTP_404_NOT_FOUND
        )
...
# Car Colors Views
class CarColorListCreateView(BaseReferenceListCreateView):
    """
    List all car colors or create a new car color.
    """

    queryset = CarColorModel.objects.all().order_by("name")
    filterset_fields: list = ["is_popular", "is_metallic", "is_pearlescent"]
    search_fields: list = ["name"]
    ordering_fields: list = ["name", "created_at", "is_popular"]
    ordering: list = ["name"]
    ...
    @swagger_auto_schema(
        ...
        tags=["🎨 Colors"],
        responses={200: "Success response with data", 404: "Not found"},
    )
    def get(self, request, *args, **kwargs):
        return super().get(request, *args, **kwargs)
...
class CarColorRetrieveUpdateDestroyView(BaseReferenceRetrieveUpdateDestroyView):
    """
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(
                description="Car color details", schema=CarColorDetailSerializer
            ),
...
@swagger_auto_schema(
    ...
    tags=["🎨 Colors"],
    responses={200: "Success response with popular colors data", 404: "Not found"},
    security=[],
)
@api_view(["GET"])
@permission_classes([])  # Public access
...
@swagger_auto_schema(
    ...
    tags=["🎨 Colors"],
    responses={200: "Success response with colors choices data", 404: "Not found"},
    security=[],
)
@api_view(["GET"])
@permission_classes([])  # Public access
...
class CarGenerationListCreateView(BaseReferenceListCreateView):
    """
    List all car generations or create a new car generation.
    """

    queryset = (
        CarGenerationModel.objects.all()
        .select_related("model__mark")
        .order_by("model__mark__name", "model__name", "year_start")
...
class CarGenerationRetrieveUpdateDestroyView(BaseReferenceRetrieveUpdateDestroyView):
    """
...
def car_generations_by_model(request):
    ...
    queryset = (
        CarGenerationModel.objects.filter(model_id=model_id)
        .select_related("model__mark")
        .order_by("year_start")
        .annotate(modifications_count=Count("modifications"))
    )
...
def car_generations_with_modifications(request, pk):
    ...
    try:
        generation = (
            CarGenerationModel.objects.select_related("model__mark")
            .prefetch_related("modifications")
            .get(pk=pk)
        )
    except CarGenerationModel.DoesNotExist:
        return Response(
            {"error": "Car generation not found"}, status=status.HTTP_404_NOT_FOUND
        )
...
class CarModificationListCreateView(BaseReferenceListCreateView):
    """
    List all car modifications or create a new car modification.
    """

    queryset = (
        CarModificationModel.objects.all()
        .select_related("generation__model__mark")
        .order_by("generation__model__mark__name", "generation__model__name", "name")
    )
...
class CarModificationRetrieveUpdateDestroyView(BaseReferenceRetrieveUpdateDestroyView):
    """
    Retrieve, update or delete a car modification.
    """

    queryset = CarModificationModel.objects.all().select_related(
        "generation__model__mark"
    )
...
def car_modifications_by_generation(request):
    ...
    queryset = (
        CarModificationModel.objects.filter(generation_id=generation_id)
        .select_related("generation__model__mark")
        .order_by("name")
    )
...
class RegionListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if search:
            ...
            print(
                f"🌍 RegionListView: Applied search filter, found {queryset.count()} regions"
            )
        ...
        for region in all_regions:
            ...
            normalized = normalized.replace("івська", "овская").replace(
                "ївська", "евская"
            )
            ...
            if normalized not in seen_normalized:
                ...
                if (
                    "ська" in region.name
                    or "цька" in region.name
                    or "івська" in region.name
                ) and (
                    "ская" in existing.name
                    or "цкая" in existing.name
                    or "овская" in existing.name
                ):
        ...
        print(
            f"🌍 RegionListView: Returning {len(unique_regions)} unique regions (search: '{search}')"
        )
    ...
    @swagger_auto_schema(
        ...
        tags=["🌍 Regions"],
        responses={200: "List of all regions"},
    )
    def get(self, request, *args, **kwargs):
        return super().get(request, *args, **kwargs)
...
class CityListView(generics.ListAPIView):
    ...
    @swagger_auto_schema(
        ...
        tags=["🏙️ Cities"],
        responses={200: "List of cities with region information"},
    )
    def get(self, request, *args, **kwargs):
        return super().get(request, *args, **kwargs)
...
class VehicleTypeListView(generics.ListAPIView):
    ...
    @swagger_auto_schema(
        ...
        tags=["🚙 Vehicle Types"],
        responses={200: "List of all vehicle types"},
    )
    def get(self, request, *args, **kwargs):
        return super().get(request, *args, **kwargs)
...
class VehicleTypeChoicesView(generics.ListAPIView):
    ...
    @swagger_auto_schema(
        ...
        tags=["🚙 Vehicle Types"],
        responses={200: "Simplified list of vehicle types for forms"},
    )
    def get(self, request, *args, **kwargs):
        return super().get(request, *args, **kwargs)
