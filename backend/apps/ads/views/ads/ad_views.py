...
# Import base views
from core.views import BaseAdListCreateView, BaseAdRetrieveUpdateDestroyView
...
class AdListCreateView(BaseAdListCreateView):
    """
...
class AdRetrieveUpdateDestroyView(BaseAdRetrieveUpdateDestroyView):
    """
