...
### 📁 Структура проекту (оновлено листопад 2025)
...
│   └── api/               # API routes
│
├── shared/                 # ✅ ЄДИНА папка для всього загального (DRY)
│   ├── components/        # Переиспользуемые компоненты
│   ├── hooks/             # Загальні хуки (useDebounce, useLocalStorage)
│   ├── types/             # Загальні типи (BaseEntity, ApiResponse)
│   ├── utils/             # Утиліти
│   ├── constants/         # Константи
│   ├── styles/            # Загальні стилі (hover-fixes, navigation)
│   ├── providers/         # React providers
│   └── index.ts           # Barrel export
│
├── components/            # UI компоненти (shadcn/ui)
│   └── ui/                # Button, Card, Tabs, etc.
│
├── modules/               # Тематичні модулі
│   ├── autoria/          # 🚗 AutoRia тема
│   ├── chatbot/          # 💬 ChatBot тема
│   └── main/             # 🏠 Main тема
│
├── lib/                   # Зовнішні бібліотеки
├── contexts/              # Глобальні контексти
├── services/              # API сервіси
└── locales/               # i18n
```

**Принципи організації:**
- ✅ **DRY** - немає дублювання shared/common
- ✅ **Next.js Best Practices** - правильна організація
- ✅ **Модульність** - тематичні модулі
- ✅ **Масштабованість** - легко розширювати

### 🎨 Система стилів та hover-ефектів

**Hover-ефекти оптимізовані для всіх тем:**
- ✅ **Контраст збережено** - текст завжди видимий
- ✅ **Плавні анімації** - transition-all 200ms
- ✅ **Accessibility** - focus-visible для клавіатури
- ✅ **DRY стилі** - переиспользуемі міксини

**Файли стилів:**
- `shared/styles/hover-fixes.module.scss` - міксини для hover
- `shared/styles/navigation.module.scss` - стилі навігації
- `components/ui/button.tsx` - покращені hover для кнопок
- `components/ui/card.tsx` - hover для карток
- `components/ui/tabs.tsx` - hover для табів

**Документація:**
- `HOVER_CONTRAST_FIXES.md` - опис виправлень
- `HOVER_TESTING_REPORT.md` - звіт тестування
- `NAVIGATION_STYLES_FIX.md` - виправлення навігації

## 🏗️ Архітектура проекту (детально)
...
**Нова система імпортів (листопад 2025):**
```tsx
// Загальні компоненти (shadcn/ui)
...
// Загальні типи
import { BaseEntity, ApiResponse } from '@/shared/types';

// Загальні стилі
import styles from '@/shared/styles/navigation.module.scss';

// Тематичні модулі
import { SearchPage } from '@/modules/autoria/search';
import { AdCard } from '@/modules/autoria/shared/components';

// Або через головний barrel
import { useDebounce, BaseEntity } from '@/shared';
```

**Важливо:**
- `@/components/ui/*` - shadcn/ui компоненти (НЕ ЗМІНЮВАТИ)
- `@/shared/*` - загальний код для всіх тем
- `@/modules/*` - тематичні модулі
